     ...
     from-gray-800 to-black text-white sm:mt-20 '>
      ...
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col
       justify-center w-full h-full'>
        ...
        <p className=' text-xl'>With a passion for problem-solving and an intellectual approach, I bring a diverse skill set to the table. My dedication to excellence and hands-on experience in multiple programming languages and frameworks make me an asset to any project. Whether it's web development or cloud solutions, I consistently deliver high-quality results, leveraging my strong technical background.</p>
